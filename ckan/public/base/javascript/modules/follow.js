	...
	return {
		...
		_onClickLoaded: function(json) {
			...
			if (options.action == 'follow') {
				...
				this.el.html('<i class="glyphicon glyphicon-remove-sign"></i> ' + this.i18n('unfollow')).removeClass('btn-success').addClass('btn-danger');
			} else {
				options.action = 'follow';
				this.el.html('<i class="glyphicon glyphicon-plus-sign"></i> ' + this.i18n('follow')).removeClass('btn-danger').addClass('btn-success');
			}
