...
this.ckan.module('image-upload', function($, _) {
  return {
    ...
    initialize: function () {
      ...
      this.button_url = $('<a href="javascript:;" class="btn"><i class="glyphicon glyphicon-globe"></i>'+this.i18n('url')+'</a>')
        .prop('title', this.i18n('url_tooltip'))
        .on('click', this._onFromWeb)
        .insertAfter(this.input);

      // Button to attach local file to the form
      this.button_upload = $('<a href="javascript:;" class="btn"><i class="glyphicon glyphicon-cloud-upload"></i>'+this.i18n('upload')+'</a>')
        .insertAfter(this.input);
